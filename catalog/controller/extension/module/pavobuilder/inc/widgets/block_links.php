...
class PA_Widget_Block_Links extends PA_Widgets {
	...
	public function render( $settings = array(), $content = '' ){
		...
		//$settings['contact'] 	= $this->url->link('information/contact', 'lien-he');
		...
		$settings['contact'] 	= 	'lien-he';
		$settings['return']		=	'tra-hang';
		$settings['sitemap']	=	'so-do-trang';
		$settings['tracking']	=	'tracking';
		$settings['manufacturer']=	'nha-san-xuat';
		$settings['voucher']	=	'phieu-qua-tang';
		$settings['affiliate']	=	'cong-tac-vien';
		$settings['special']	=	'khuyen-mai';
		$settings['account']	=	'tai-khoan-cua-toi';
		$settings['order']		=	'lich-su-don-hang';
		$settings['wishlist']	=	'danh-sach-yeu-thich';
		$settings['newsletter']	=	'thu-thong-bao';
